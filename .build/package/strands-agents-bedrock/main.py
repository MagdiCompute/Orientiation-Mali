...
class ExamplenameError(Exception):
    """Base exception for strands-agents-bedrock errors."""
    pass
...
class Client:
    """
    The primary interface for the strands-agents-bedrock service.
    
    Usage:
        >>> from strands-agents-bedrock import Client
    ...
    def connect(self) -> bool:
        ...
        print(f"[+] strands-agents-bedrock: Connected with session {self._session_id}")
        return True
    ...
    def disconnect(self):
        ...
        print("[-] strands-agents-bedrock: Connection closed.")
